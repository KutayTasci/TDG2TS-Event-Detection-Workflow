...
class TdGraphEmbed():
    def __init__(self, dataset_name):
        with open("tdGraphEmbed/tdGraphEmbed/config.json", 'rb') as f:
            config = json.load(f)
    ...
    def run_doc2vec(self, documents):
        ...
        model.save(f"tdGraphEmbed/trained_models/{self.dataset_name}.model")
        print("Model Saved")
    ...
    def get_embeddings(self):
        ...
        '''
        model_path = f"tdGraphEmbed/trained_models/{self.dataset_name}.model"
